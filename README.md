...
Subadub Reactor is a fork of the Subadub extension that adds helpful features similar to those found in Langauge Reactor.
...
- Key controls are offered to quickly navigate subtiles:
  - A: Previous subtitle
  - D: Next subtitle
  - S: Replay subtitle
  - Q: Auto pause after subtitle
